import { Body, Caption, Container, CustomNavLink, PrimaryButton, ProfileCard, Title } from "../../router";
                ...
                <Container className="flex items-center justify-between md:flex-row flex-col">
                    <div className="w-full md:w-1/2 text-white pr-12">
                        ...
                        <Body className="leading-7 text-gray-200 my-8">
                            "Bidding isn't just about winning—it's about playing smart, seizing the right moment, 
                            and getting more value every time you raise your hand. Turn every bid into an opportunity. 
                            Compete with confidence, win with smart moves, and unlock the best deals right at your fingertips."
                        </Body>
                        <SearchBox />
                    ...
                    <div className="w-full md:w-1/2 my-16 relative py-16">
                        ...
                        <div className="horiz-move absolute md:top-28 top-8 left-0">
                            <Box title="Proof of quality" desc="Verified sellers. Trusted products." />
                        </div>
                        <div className="horiz-move absolute bottom-72 right-0">
                            <Box title="Safe and secure" desc="Trusted—every step of the way." />
                        </div>
