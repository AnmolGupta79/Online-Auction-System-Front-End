...
export const AddProduct = () => {
  ...
  const handleimageChange = (e) => {
    ...
    setImagePreview(URL.createObjectURL(e.target.files));
  };
          ...
          {category && (
            <>
              ...
              <div className="flex items-center gap-5 my-4">
                ...
                <div className="w-1/2">
                  <Caption className="mb-2">Medium used <span className="text-purple-400 italic">(Typically,pencil,ink,charcoal or other)</span></Caption>
