...
export const ProductList = () => {
   ...
   const { useproducts, isLoading } = useSelector((state) => state.product);
   ...
   return (
      <>
         <section className="shadow-s1 p-8 rounded-lg">
            ...
            <hr className="my-5" />
            <table products={useproducts} handleDeleteProduct={handleDeleteProduct} handleSellProduct={handleSellProduct} />
         </section>
      </>
   );
};